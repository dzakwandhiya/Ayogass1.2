...
<body>
    ...
    <div class="banner">
        ...
        <div class="content">
            <div class="orders">
                <h1 style="font-weight: bold">UPLOAD BUKTI PEMBAYARAN</h1>
                <hr>
                <div class="scrol">
                    <div class="order">
                        <div class="order-content">
                            ...
                            <form action="{{ route('storeBuktiPembayaran', $transaction->id) }}" method="POST"
                                id="upload" enctype="multipart/form-data">
                                @csrf
                                <div style="margin-left:auto; margin-right:auto; width: 50%">

                                    <div class="mb-3 w-100">
                                        <p class="text-center" style="font-weight: bold; margin-top:20px">UPLOAD FOTO
